...
export default class ES6ModuleSyntax extends Component<Props> {
    ...
    componentDidMount() {
        ...
        // 严格模式
        this.ModuleStrictModule();

        // export 命令
        this.ModuleExportCMD();

        // import 命令
        this.ModuleImportCMD();

        // 模块的整体加载
        this.ModuleLoad();

        // export default 命令
        this.ModuleExportDefaultCMD();

        // export 与 import 的复合写法
        this.ModuleExportImportCMD();
    ...
    ModuleBrief(){
         ...
         * 无法将一个大程序拆分成互相依赖的小文件，
         * 再用简单的方法拼装起来。其他语言都有这项功能，
         * 比如 Ruby 的require、Python 的import，甚至就连 CSS 都有@import，
        ...
        // let _fs1 = require('fs');
        // let stat1 = _fs.stat;
        // let exists1 = _fs.exists;
        // let readfile1 = _fs.readfile;
    ...
    ModuleExportCMD(){
        ...
        /**上面的写法会报错，因为import或者export要出现在模块的顶层
         *  也就是说 在他们要出现在  类的申明前面
         *
    ...
    ModuleImportCMD(){
        ...
        /**目前阶段，通过 Babel 转码，
         * CommonJS 模块的require命令和 ES6 模块的import命令，
    ...
    ModuleImportFunc(){
         ...
         * 先于模块内的其他语句执行（import命令叫做“连接” binding 其实更合适）。
         * 所以，下面的代码会报错。
         * */
        // // 报错
        // if (x === 2) {
